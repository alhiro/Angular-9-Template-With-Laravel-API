...
!(function(t) {
  ...
  function M(e) {
    var n,
      ...
      s = [];
    for (
      'string' == typeof e ? (s = e.split(/\s*,\s*/)) : 'function' == typeof e ? (s = [e]) : t.isArray(e) && (s = e),
        n = 0;
      n < s.length;
      n++
    )
  ...
  function Y(t, n) {
    ...
    return tt(t)
      ? e.duration(t * n)
      : ((i = t.asMonths()),
        Math.abs(i) >= 1 && vt(i) ? e.duration({ months: i * n }) : e.duration({ days: t.asDays() * n }));
  }
  function q(t) {
  ...
  se.push('_fullCalendar'),
    ...
    (ie.stripZone = function() {
      var t;
      return (
        this._ambigZone || ((t = this._ambigTime), this.utc(!0), (this._ambigTime = t || !1), (this._ambigZone = !0)),
        this
      );
    }),
    (ie.hasZone = function() {
  ...
  var ue = bt.extend(fe, ge, {
    ...
    _watchDeps: function(t, e, n) {
      ...
      function r(t, n, i) {
        void 0 === n ? (i || void 0 === h[t] || u--, delete h[t]) : (i || void 0 !== h[t] || u++, (h[t] = n)),
          --a || (u === l && (d || e(h)));
      }
      function s(t, e) {
        o.on(t, e), c.push([t, e]);
  ...
  var de = ce.extend({
    ...
    queue: function(t, e, n) {
      ...
      e && (i = this.waitsByNamespace[e]),
        this.waitNamespace &&
          (e === this.waitNamespace && null != i ? this.delayWait(i) : (this.clearWait(), this.tryStart())),
    ...
    compoundTask: function(t) {
      ...
      if (t.namespace && ('destroy' === t.type || 'init' === t.type)) {
        ...
        'destroy' === t.type
          ? i.length &&
            ((n = i[i.length - 1]),
            n.namespace === t.namespace && ('init' === n.type ? ((r = !1), i.pop()) : 'destroy' === n.type && (r = !1)))
          : 'init' === t.type &&
            i.length &&
    ...
    setScrollVel: function(t, e) {
      (this.scrollTopVel = t),
        ...
        (!this.scrollTopVel && !this.scrollLeftVel) ||
          ...
          (this.scrollIntervalId = setInterval(mt(this, 'scrollIntervalFunc'), this.scrollIntervalMs));
    },
  ...
  var ye = me.extend({
    ...
    queryHit: function(t, e) {
      return (
        this.coordAdjust && ((t += this.coordAdjust.left), (e += this.coordAdjust.top)), this.component.queryHit(t, e)
      );
    }
  });
    ...
    be = (Zt.Grid = bt.extend(ge, {
      ...
      dayMousedown: function(t) {
        ...
        we.get().shouldIgnoreMouse() ||
          ...
          e.opt('selectable') && this.daySelectListener.startInteraction(t, { distance: e.opt('selectMinDistance') }));
      },
  ...
  be.mixin({
    ...
    buildBusinessHourEvents: function(e, n) {
      ...
      return (
        ...
        !i.length &&
          n &&
          (i = [t.extend({}, Ne, { start: this.view.activeRange.end, end: this.view.activeRange.end, dow: null })]),
        i
      );
    },
    ...
    startSegResize: function(e, n, i) {
      return (
        ...
        (this.buildSegResizeListener(e, t(n.target).is('.fc-start-resizer')).startInteraction(n, i), !0)
      );
    },
    ...
    listenToExternalDrag: function(t, e, n) {
      ...
      (r.externalDragListener = new ye(this, {
        ...
        hitOver: function(t) {
          ...
          n ? ((i = r.computeExternalDrop(n, l)), (e = i && r.isExternalLocationAllowed(i, l.eventProps))) : (e = !1),
            e || ((i = null), s()),
            i && r.renderDrag(i);
        },
        hitOut: function() {
      ...
      return (this.segResizeListener = new ye(this, {
        ...
        hitOver: function(n, o, l) {
          ...
          d && f
            ...
            : (u = !1),
            u
              ? i.start.isSame(h.start.clone().stripZone()) && i.end.isSame(c.clone().stripZone()) && (i = null)
              : ((i = null), s()),
    ...
    getSegClasses: function(t, e, n) {
      var i = this.view,
        r = ['fc-event', t.isStart ? 'fc-start' : 'fc-not-start', t.isEnd ? 'fc-end' : 'fc-not-end'].concat(
          this.getSegCustomClasses(t)
        );
      return (
        e && r.push('fc-draggable'), n && r.push('fc-resizable'), i.isEventSelected(t.event) && r.push('fc-selected'), r
      );
    },
      ...
      sliceRangeByRow: function(t) {
        ...
        for (e = 0; e < this.rowCnt; e++)
          (n = e * o),
            ...
            (s = Math.floor(s)),
            r <= s &&
              h.push({ row: e, firstRowDayIndex: r - n, lastRowDayIndex: s - n, isStart: r === l, isEnd: s === u });
        return h;
      },
        ...
        for (e = 0; e < this.rowCnt; e++)
          for (n = e * a, i = n + a - 1, r = n; r <= i; r++)
            (s = Math.max(u, r)),
              ...
              (o = Math.floor(o)),
              s <= o &&
                c.push({ row: e, firstRowDayIndex: s - n, lastRowDayIndex: o - n, isStart: s === u, isEnd: o === h });
        return c;
      },
      ...
      renderNumberCellHtml: function(t) {
        ...
        return o || i.cellWeekNumbersVisible
          ? ((e = this.getDayClasses(t)),
            ...
            i.cellWeekNumbersVisible &&
              t.day() == n &&
              (r += i.buildGotoAnchorHtml({ date: t, type: 'week' }, { class: 'fc-week-number' }, t.format('w'))),
  ...
  De.mixin({
    ...
    renderSegRow: function(e, n) {
      function i(e) {
        for (; o < e; )
          (h = (m[r - 1] || [])[o]),
            h ? h.attr('rowspan', parseInt(h.attr('rowspan') || 1, 10) + 1) : ((h = t('<td/>')), a.append(h)),
            (v[r][o] = h),
            (m[r][o] = h),
            o++;
      }
          ...
          for (l = 0; l < s.length; l++) {
            for (
              u = s[l],
                ...
                u.leftCol != u.rightCol ? h.attr('colspan', u.rightCol - u.leftCol + 1) : (m[r][o] = h);
              o <= u.rightCol;
  ...
  var Ce = (Zt.View = ue.extend({
    ...
    computeDayRange: function(t) {
      var e,
        ...
        r = null;
      return (
        i && ((r = i.clone().stripTime()), (e = +i.time()) && e >= this.nextDayThreshold && r.add(1, 'days')),
  ...
  var He = (Zt.Scroller = bt.extend({
    ...
    lockOverflow: function(t) {
      ...
      (t = t || this.getScrollbarWidths()),
        'auto' === e &&
          (e =
            t.top || t.bottom || this.scrollEl[0].scrollWidth - 1 > this.scrollEl[0].clientWidth ? 'scroll' : 'hidden'),
        'auto' === n &&
          (n =
    ...
    Re.mixin({
      ...
      updateSize: function(t) {
        if (this.elementVisible())
          return (
            t && this._calcSize(), this.ignoreWindowResize++, this.view.updateSize(!0), this.ignoreWindowResize--, !0
          );
      },
      calcSize: function() {
  ...
  var ze = (Zt.BasicView = Ce.extend({
      ...
      setHeight: function(t, e) {
        ...
        this.scroller.clear(),
          ...
          e ||
            ...
            (s.left || s.right) &&
              (i(this.headRowEl, s), (n = this.computeScrollerHeight(t)), this.scroller.setHeight(n)),
    ...
    Fe = {
      ...
      renderBgIntroHtml: function() {
        var t = this.view;
        return t.colWeekNumbersVisible
          ? '<td class="fc-week-number ' + t.widgetContentClass + '" ' + t.weekNumberStyleAttr() + '></td>'
          : '';
      },
      renderIntroHtml: function() {
        var t = this.view;
      ...
      setHeight: function(t, e) {
        ...
        this.bottomRuleEl.hide(),
          ...
          e ||
            ...
            (o.left || o.right) &&
              (i(this.noScrollRowEls, o), (s = this.computeScrollerHeight(t)), this.scroller.setHeight(s)),
        ...
        return e.opt('weekNumbers')
          ? ((t = this.start.format(e.opt('smallWeekFormat'))),
            '<th class="fc-axis fc-week-number ' +
              ...
              e.axisStyleAttr() +
              '>' +
              e.buildGotoAnchorHtml({ date: this.start, type: 'week', forceOff: this.colCnt > 1 }, ht(t)) +
              '</th>')
  ...
  ($t.agenda = { class: Ge, defaults: { allDaySlot: !0, slotDuration: '00:30:00', slotEventOverlap: !0 } }),
