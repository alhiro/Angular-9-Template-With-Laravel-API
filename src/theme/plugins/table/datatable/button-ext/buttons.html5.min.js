(function(e) {
  ...
  if ('undefined' === typeof f || ('undefined' !== typeof navigator && /MSIE [1-9]\./.test(navigator.userAgent)))
    r = void 0;
  else {
  ...
  p.ext.buttons.excelHtml5 = {
    ...
    action: function(a, b, d, c) {
          ...
          for (var b = 0, d = a.length; b < d; b++) {
            ...
            f ||
              ('number' === typeof a[b] || (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                ...
                : ((m = !a[b].replace ? a[b] : a[b].replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, '')),
                  (f = o(g, 'c', {
      ...
      for (n = d.header.length; j < n; j++)
        b.appendChild(o(g, 'col', { attr: { min: j + 1, max: j + 1, width: J(d, j), customWidth: 1 } }));
  ...
  p.ext.buttons.pdfHtml5 = {
    ...
    action: function(a, b, d, c) {
      ...
      b.messageTop && a.content.unshift({ text: b.messageTop, style: 'message', margin: [0, 0, 0, 12] });
