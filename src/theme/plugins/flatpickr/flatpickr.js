          ...
          window.requestAnimationFrame(function() {
            if (
              (void 0 !== h.calendarContainer &&
                ((h.calendarContainer.style.visibility = 'hidden'), (h.calendarContainer.style.display = 'block')),
          ...
          (function(e) {
            ...
            if (void 0 !== n.value && 2 === n.value.length) {
              ...
              s < a
                ...
                : s > r && ((s = n === h.hourElement ? s - r - o(!h.amPM) : a), f && j(void 0, 1, h.hourElement)),
                h.amPM &&
                  u &&
    ...
    function ne(e) {
      if (
        ...
        for (
          ...
          X(new Date(c), !0) ||
            ((o = o || (c > a && c < i)), c < n && (!r || c > r) ? (r = c) : c > n && (!l || c < l) && (l = c));
    ...
    (h.parseDate = D({ config: h.config, l10n: h.l10n })),
      ...
      (h.clear = function(e, t) {
        ...
        (h.selectedDates = []),
          ...
          !0 === t && ((h.currentYear = h._initialDate.getFullYear()), (h.currentMonth = h._initialDate.getMonth()));
      ...
      (h.open = function(e, t) {
        ...
        var n = h.isOpen;
        (h.isOpen = !0),
          n || (h.calendarContainer.classList.add('open'), h._input.classList.add('active'), ge('onOpen'), le(t));
    ...
    function we(e) {
      void 0 === e && (e = !0),
        void 0 !== h.mobileInput &&
          h.mobileFormatStr &&
          (h.mobileInput.value =
            void 0 !== h.latestSelectedDateObj ? h.formatDate(h.latestSelectedDateObj, h.mobileFormatStr) : ''),
        ...
        (h.element = h.input = f),
          ...
          (function() {
            ...
            if (!i.dateFormat && (i.enableTime || r)) {
              ...
              o.dateFormat =
                i.noCalendar || r ? 'H:i' + (i.enableSeconds ? ':S' : '') : c + ' H:i' + (i.enableSeconds ? ':S' : '');
            }
                  ...
                  (function() {
                    ...
                    if (
                      ...
                      (h.minuteElement.value = i(
                        h.latestSelectedDateObj ? h.latestSelectedDateObj.getMinutes() : h.config.defaultMinute
                      )),
                      ...
                      (h.secondElement = a.getElementsByTagName('input')[0]),
                        (h.secondElement.value = i(
                          h.latestSelectedDateObj ? h.latestSelectedDateObj.getSeconds() : h.config.defaultSeconds
                        )),
                    ...
                    return (
                      h.config.time_24hr ||
                        ((h.amPM = d(
                          'span',
                          'flatpickr-am-pm',
                          h.l10n.amPM[o((h.latestSelectedDateObj ? h.hourElement.value : h.config.defaultHour) > 11)]
                        )),
              ...
              if (
                ...
                h.config.inline &&
                  (!r && h.element.parentNode
                    ...
                    : void 0 !== h.config.appendTo && h.config.appendTo.appendChild(h.calendarContainer)),
                h.config.static)
              ) {
          ...
          (h.selectedDates.length || h.config.noCalendar) &&
            (h.config.enableTime && I(h.config.noCalendar ? h.latestSelectedDateObj || h.config.minDate : void 0),
            we(!1)),
          x(),
