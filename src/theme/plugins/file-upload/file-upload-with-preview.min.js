      ...
      function A(e, t) {
        ...
        if (
          ...
          (this.options.showDeleteButtonOnImages =
            !this.options.hasOwnProperty('showDeleteButtonOnImages') || this.options.showDeleteButtonOnImages),
            ...
            value: function(A) {
              if (0 !== A.length) {
                ...
                var g = new CustomEvent('fileUploadWithPreview:imagesAdded', {
                  detail: { uploadId: this.uploadId, cachedFileArray: this.cachedFileArray, addedFilesCount: A.length }
                });
                          ...
                          for (;;)
                            switch ((e.prev = e.next)) {
                              ...
                              case 2:
                                ...
                                return (
                                  (r = void 0), (C = void 0), (e.prev = 5), (e.next = 8), fetch(A[E], { mode: 'cors' })
                                );
                              case 8:
