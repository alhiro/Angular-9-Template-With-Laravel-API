  ...
  (function(g) {
    ...
    k.prototype = {
      ...
      createDropdown: function() {
        ...
        var q =
          this.multiple && this.options.actionsBox
            ? '<div class="bs-actionsbox"><div class="btn-group btn-group-sm btn-block"><button type="button" class="actions-btn bs-select-all btn btn-default btn-primary">' +
              this.options.selectAllText +
              '</button><button type="button" class="actions-btn bs-deselect-all btn btn-default btn-primary">' +
              this.options.deselectAllText +
              '</button></div></div>'
            : '';
        var n =
          this.multiple && this.options.doneButton
            ? '<div class="bs-donebutton"><div class="btn-group btn-block"><button type="button" class="btn btn-sm btn-default btn-primary">' +
      ...
      createLi: function() {
        ...
        var v = function(B, y, A, z) {
          ...
          return (
            ...
            (A ? ' style="' + A + '"' : '') +
            (u.options.liveSearchNormalize ? ' data-normalized-text="' + c(l(g(B).html())) + '"' : '') +
      ...
      setSelected: function(n, p, o) {
        ...
        o.toggleClass('selected', p)
          .find('span.dropdown-item-inner')
          .attr('aria-selected', p);
      },
      ...
      keydown: function(x) {
        ...
        if (
          (/(13|32)/.test(x.keyCode.toString(10)) || (/(^9$)/.test(x.keyCode.toString(10)) && u.options.selectOnTab)) &&
          z
        ) {
