(function(e, t) {
  ...
  var a =
    ...
    G = function() {
      var e = Array.prototype.slice
          ...
          .sort(function(e, t) {
            return ((e = parseInt(e.getAttribute('tabindex'))), (t = parseInt(t.getAttribute('tabindex'))), e > t)
              ? 1
              : e < t
              ? -1
              : 0;
              ...
              r(n, [
                {
                  key: '_main',
                  value: function(e) {
                    return l(n.prototype.__proto__ || Object.getPrototypeOf(n.prototype), '_main', this).call(
                      this,
                      s({}, t, e)
                    );
                  }
      ...
      _main: function(e) {
        ...
        return new Promise(function(e, n) {
          ...
          if (
            ...
            (r.popup.onmousedown = function() {
              ...
              (r.container.onclick = function(t) {
                return i
                  ? void (i = !1)
                  : void (t.target !== r.container || (v(o.allowOutsideClick) && d(l.DismissReason.backdrop)));
              });
          }
          o.reverseButtons
          ...
          ue.keydownHandlerAdded &&
            (window.removeEventListener('keydown', ue.keydownHandler, { capture: !0 }), (ue.keydownHandlerAdded = !1)),
            o.toast ||
          ...
          for (
            var B = ['input', 'file', 'range', 'select', 'radio', 'checkbox', 'textarea'], A = void 0, E = 0;
            E < B.length;
            E++
          ) {
            var P = k[B[E]],
  ...
  var _e = e(
    (function(e) {
      ...
      return (
        'undefined' != typeof window && 'object' === a(window._swalDefaults) && t.setDefaults(window._swalDefaults), t
      );
    })(o)
  );
