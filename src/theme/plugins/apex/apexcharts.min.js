            ...
            },
            {
              ...
              value: function() {
                ...
                if (
                  ...
                  o.push(-n.minY / r[0]),
                    n.minY !== Number.MIN_VALUE && 0 !== Math.abs(n.minY) && ((l = -n.minY / t), (h = n.minX / e));
                return {
                  yRatio: r,
                  invertedYRatio: t,
                  zRatio: a,
          ...
          },
          {
            ...
            value: function(t) {
              ...
              return (
                ...
                -1 === o.indexOf('rgb')
                  ? (c = d.hexToRgba(o, h))
                  : o.indexOf('rgba') > -1 && (h = '0.' + d.getOpacityFromRGBA(r[this.seriesIndex])),
            ...
            value: function(t, e, i, s, a, n, r) {
              ...
              if (o.globals.dataChanged)
                if (this.dynamicAnim) {
                  ...
                  0 === t && 0 === e && (s = 0),
                    h.animateCircle(v, { cx: k, cy: A, r: L }, { cx: t, cy: e, r: s }, P, o.globals.easing);
                } else v.attr({ r: s });
              return (
        ...
        s(t, [
          {
            ...
            value: function(t, e) {
              ...
              for (var r = 0, o = 0; r < t.length; r++, o++) {
                ...
                for (
                  var z = s.group({ class: 'apexcharts-datalabels' }), P = 0, M = i.globals.dataPoints;
          ...
          },
          {
            ...
            value: function(t, e, i, s) {
              ...
              return (
                ...
                n.fillPath({ seriesNumber: this.barOptions.distributed ? o : s, color: r, value: t[e][i] })
              );
            }
          },
          {
                  ...
                  y: (s =
                    void 0 === this.series[g][p] || null === this.series[g][p]
                      ...
                      : l -
                        ...
                        2 * (this.isReversed ? this.series[g][p] / this.yRatio[this.yaxisIndex] : 0)),
                  zeroH: l
                },
                y = this.barEndingShape(d, v, this.series, g, p);
              if (
        ...
        s(i, [
          {
            ...
            value: function(t, e) {
              ...
              (t = n.getLogSeries(t)),
                ...
                this.initVariables(t);
              for (
                var r = s.group({ class: 'apexcharts-candlestick-series apexcharts-plot-series' }), o = 0, l = 0;
                o < t.length;
                o++, l++
              ) {
                var h,
          ...
          },
          {
            ...
            value: function(t, e) {
              ...
              for (var g = 0; g < t.length; g++) {
                ...
                if (
                  (v.attr({ id: 'apexcharts-'.concat(i.config.chart.type, '-slice-').concat(g), index: 0, j: g }),
            ...
            value: function(t) {
              ...
              for (var v = m ? t.series.length - 1 : 0; m ? v >= 0 : v < t.series.length; m ? v-- : v++) {
                ...
                e.globals.dataChanged &&
                  ((A = this.startAngle), (P = Math.round((C * d.negToZero(e.globals.previousPaths[v])) / 100) + A)),
        ...
        s(i, [
          {
            ...
            value: function(t, e) {
              ...
              (this.rangeBarOptions = this.w.config.plotOptions.rangeBar),
                ...
                this.initVariables(t);
              for (
                var n = s.group({ class: 'apexcharts-rangebar-series apexcharts-plot-series' }), r = 0, o = 0;
                r < t.length;
                r++, o++
              ) {
                var l,
        ...
        s(t, [
          {
            ...
            value: function(t, e, i) {
              ...
              for (
                ...
                for (
                  var $ = s.globals.dataPoints > 1 ? s.globals.dataPoints - 1 : s.globals.dataPoints, J = 0;
                  J < $;
                  J++
                ) {
                  ...
                  s.config.chart.stacked
                    ? ((U =
                        v > 0 && s.globals.collapsedSeries.length < s.config.series.length - 1 ? b[v - 1][J + 1] : M),
                      (X =
            ...
            value: function(t) {
              ...
              if (void 0 !== i[e][0])
                n = l.config.chart.stacked
                  ? (o = e > 0 ? r[e - 1][0] : a) - i[e][0] / s + 2 * (this.isReversed ? i[e][0] / s : 0)
        ...
        s(t, [
          {
            ...
            value: function(t, e, i) {
              var s = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 0,
                ...
                n = this.w,
                r =
                  (void 0 === this.w.config.yaxis[s].max && void 0 === this.w.config.yaxis[s].min) ||
                ...
                t.w.config.series.forEach(function(t) {
                  ...
                  (a = s = n),
                    t.data.forEach(function(t) {
                      t[0] <= e.xaxis.max &&
                        t[0] >= e.xaxis.min &&
                        (t[1] > a && null !== t[1] && (a = t[1]), t[1] < s && null !== t[1] && (s = t[1]));
                    }),
                    (s *= 0.95),
                    (a *= 1.05),
                    i.push({ min: s, max: a });
              ...
              if (
                ...
                i.config.yaxis.forEach(function(a, n) {
                  ...
                  (!a.show ||
                    ...
                    (((s && i.globals.isMultipleYAxis && -1 !== i.globals.collapsedSeriesIndices.indexOf(n)) ||
                      (i.globals.isBarHorizontal && a.opposite)) &&
                      ((r = t), i.config.grid.padding.left < r.width && (e.xPadLeft = r.width / 2 + 1)),
                    ((!i.globals.isBarHorizontal && a.opposite && -1 !== i.globals.collapsedSeriesIndices.indexOf(n)) ||
                ...
                (e.config.chart.brush.targets || [e.config.chart.brush.target]).forEach(function(i) {
                  ...
                  var a = function() {
                    t.ctx._updateOptions(
                      { chart: { selection: { xaxis: { min: s.w.globals.minX, max: s.w.globals.maxX } } } },
                      !1,
                      !1
                    );
                  };
                ...
                if (t.config.grid.yaxis.lines.show)
                  for (var p = 0, x = 0, b = t.globals.gridWidth, m = 0; m < t.globals.dataPoints + 1; m++) {
                    ...
                    a.add(v),
                      ...
                      this.animY && this.animateLine(v, { y1: p + 20, y2: x + 20 }, { y1: p, y2: x }),
                ...
                if (t.config.grid.yaxis.lines.show)
                  for (var E = 0, T = 0, X = t.globals.gridWidth, I = 0; I < o + 1; I++) {
                    ...
                    a.add(Y),
                      ...
                      this.animY && this.animateLine(Y, { y1: E + 20, y2: T + 20 }, { y1: E, y2: T }),
                ...
                (a = parseInt(u.getAttribute('j'))),
                  ...
                  s.config.tooltip.followCursor
                    ? s.globals.isBarHorizontal
                      ...
                      : ((o = s.globals.isXNumeric ? b - x / 2 : b - n.dataPointsDividedWidth + x / 2),
          ...
          case 'A':
            t = (e = (function(t, e) {
              ...
              (i = new SVG.Point((F.x - R.x) / 2, (F.y - R.y) / 2).transform(new SVG.Matrix().rotate(E))),
                (s = (i.x * i.x) / (P * P) + (i.y * i.y) / (M * M)) > 1 && ((s = Math.sqrt(s)), (P *= s), (M *= s));
              (a = new SVG.Matrix()
                .rotate(E)
                .scale(1 / P, 1 / M)
                .rotate(-E)),
          ...
          [
            ...
            },
            {
              ...
              value: function(t, e) {
                ...
                var s = this.w.globals;
                if (
                  ((s.noData = !1), (s.animationEnded = !1), this.responsive.checkResponsiveConfig(e), null === this.el)
                )
