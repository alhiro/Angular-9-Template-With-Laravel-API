    ...
    (o = function(e, t, n, i) {
      ...
      function p(t, n) {
        function a(t, a, r) {
          ...
          if (
            ((null !== t && '' !== t) ||
              ((o = null !== r.regex) ? (t = (t = r.regex).replace(/^(\^)(.*)(\$)$/, '$2')) : ((o = !0), (t = '.*'))),
          ...
          return (
            u.prototype.masksCache[c] === i || !0 === n
              ? ((l = {
                ...
                !0 !== n && ((u.prototype.masksCache[c] = l), (l = e.extend(!0, {}, u.prototype.masksCache[c]))))
      ...
      function m(a, c, p) {
          ...
          for (
            ...
            (!(
              ...
              ((p.greedy && !0 !== a.match.optionalQuantifier) ||
                ((!1 === a.match.optionality || !1 === a.match.newBlockMarker) && !0 !== a.match.optionalQuantifier)) &&
              (r.alternation === i ||
                r.alternation !== a.alternation ||
                (a.locator[r.alternation] !== i && L(a.locator[r.alternation].toString().split(','), o)))
            ) ||
              ...
              function k(e, t) {
                function n(e) {
                  for (var t, n, i = [], a = 0, r = e.length; a < r; a++)
                    if ('-' === e.charAt(a)) for (n = e.charCodeAt(a + 1); ++t < n; ) i.push(String.fromCharCode(t));
                    else (t = e.charCodeAt(a)), i.push(e.charAt(a));
                  return i.join('');
                }
                return p.regex && null !== e.match.fn && null !== t.match.fn
                  ? -1 !== n(t.match.def.replace(/[\[\]]/g, '')).indexOf(n(e.match.def.replace(/[\[\]]/g, '')))
                ...
                if (
                  ...
                  if (n !== i) {
                    if (
                      ...
                      for (var a in t.mloc)
                        'string' == typeof a && (a = a.split(',')[0]), e.mloc[a] === i && (e.mloc[a] = t.mloc[a]);
              ...
              if (o.matches !== i) {
                if (o.isGroup && u !== o) {
                  ...
                  if (-1 === E || 'string' == typeof E) {
                    ...
                    (!0 === p.keepStatic || (isFinite(parseInt(p.keepStatic)) && O >= p.keepStatic)) &&
                      (_ = _.slice(0, 1));
                    for (var R = !1, N = 0; N < _.length; N++) {
                      (w = parseInt(_[N])),
                        (m = []),
                        (a = ('string' == typeof E && v(c, w, C)) || D.slice()),
                        P.matches[w] && l(P.matches[w], [w].concat(s), u) ? (o = !0) : 0 === N && (R = !0),
                        (x = m.slice()),
                        (c = O),
                        (m = []);
                      for (var G = 0; G < x.length; G++) {
                        ...
                        for (var L = 0; L < S.length; L++) {
                          ...
                          if (
                            'string' != typeof E ||
                            (I.alternation !== i && -1 !== e.inArray(I.locator[I.alternation].toString(), _))
                          ) {
                  ...
                  for (
                    ...
                    if ((o = l(U, [K].concat(s), U))) {
                      if (
                        (((r = m[m.length - 1].match).optionalQuantifier = K > V.quantifier.min - 1),
          ...
          if (t > -1) {
            if (n === i) {
              ...
              v !== i &&
                ...
                s.length > 0 &&
                  (s[0].alternation === i
                    ? 0 === (l = D(o, s.slice()).locator.slice()).length && (l = s[0].locator.slice())
        ...
        function G() {
          return (
            M()._buffer === i && ((M()._buffer = E(!1, 1)), M().buffer === i && (M().buffer = M()._buffer.slice())),
            M()._buffer
          );
        }
        function I(e) {
        ...
        function H(t, n, a, r, o) {
          ...
          if (l !== i) {
            (m = parseInt(s)), (M().excludes[m] = M().excludes[m] || []), !0 !== t && M().excludes[m].push(_(c));
            var v = [],
              k = 0;
            for (p = m; p < O(i, !0) + 1; p++)
              (f = M().validPositions[p]) && !0 !== f.generatedInput ? v.push(f.input) : p < t && k++,
            ...
            for (; M().excludes[m] && M().excludes[m].length < 10; ) {
              ...
              for (M().excludes[m].push(S), p = m; p < O(i, !0) + 1; p++) delete M().validPositions[p];
            }
          }
              ...
              e.each(N(n), function(c, f) {
                ...
                if (
                  ...
                  var d = s.c !== i ? s.c : a,
                    h = n;
                  return (
                    (d = d === p.skipOptionalPartCharacter && null === m.fn ? $(n, m, !0) || m.def : d),
                    s.remove !== i &&
                            ...
                            input: (function(t, n, i) {
                              switch (p.casing || n.casing) {
                                ...
                                case 'title':
                                  ...
                                  t =
                                    0 === i || (a && a.input === String.fromCharCode(u.keyCode.SPACE))
                                      ? t.toUpperCase()
                                      : t.toLowerCase();
                                  break;
                                default:
            ...
            if (M().validPositions[o] === i && !z(o, !0)) {
              ...
              if (s) {
                ...
                if (
                  ...
                  ((f = e.extend({}, f, { input: $(o, f.match, !0) || f.match.def })).generatedInput = !0),
                  U(o, f, !0),
                  !0 !== a)
                ) {
        ...
        function U(t, n, a, r) {
          ...
          if (
            ...
            var u = e.extend(!0, {}, M().validPositions),
              c = O(i, !0);
            for (M().p = s, g = c; g >= s; g--)
              M().validPositions[g] && '+' === M().validPositions[g].match.nativeDef && (p.isNegative = !1),
              ...
              if (v !== i && (g >= l || (g >= s && !0 !== v.generatedInput && o(g, u, { begin: s, end: l })))) {
                for (; '' !== T(h).match.def; ) {
                  if (!1 === d && u[h] && u[h].match.nativeDef === v.match.nativeDef)
                    ...
                    !(f = !0 === v.generatedInput || (v.input === p.radixPoint && !0 === p.numericInput)) &&
                    '' === T(h).match.def
                  )
                    break;
                  if (f) break;
        ...
        function q(e, t) {
          for (
            var n = e + 1;
            '' !== T(n).match.def && ((!0 === t && (!0 !== T(n).match.newBlockMarker || !z(n))) || (!0 !== t && !z(n)));
        ...
        function Q(e, t) {
          ...
          for (
            ...
            ((!0 === t && !0 !== T(i).match.newBlockMarker) ||
              (!0 !== t && !z(i) && ((n = N(i)).length < 2 || (2 === n.length && '' === n[1].match.def))));
              ...
              if (o.length > 1 + ('' === o[o.length - 1].match.def ? 1 : 0))
                for (var l = 0; l < o.length; l++)
                  if (
                    ...
                    (null === o[l].match.fn || r === i || !1 !== o[l].match.fn.test(r.match.def, M(), t, !0, p)) &&
                    (s.push(o[l]),
          ...
          J = {
            on: function(t, n, a) {
              ...
              (t.inputmask.events[n] = t.inputmask.events[n] || []),
                ...
                -1 !== e.inArray(n, ['submit', 'reset']) ? null !== t.form && e(t.form).on(n, s) : e(t).on(n, s);
            },
            off: function(t, n) {
              var i;
              t.inputmask &&
          ...
          Y = {
            keydownEvent: function(t) {
              ...
              if (
                ...
                (a === u.keyCode.HOME && !t.shiftKey) || a === u.keyCode.PAGE_UP
                  ...
                  : ((p.undoOnEscape && a === u.keyCode.ESCAPE) || (90 === a && t.ctrlKey)) && !0 !== t.altKey
                  ...
                  ? !0 === p.tabThrough && a === u.keyCode.TAB
                    ? (!0 === t.shiftKey
                        ? (null === T(r.begin).match.fn && (r.begin = q(r.begin)),
                          (r.end = Q(r.begin, !0)),
                          (r.begin = Q(r.end, !0)))
                        : ((r.begin = q(r.begin, !0)), (r.end = q(r.begin, !0)), r.end < M().maskLength && r.end--),
            ...
            keypressEvent: function(t, n, a, r, o) {
              ...
              if (c) {
                ...
                if (
                  (!1 !== k &&
                    (w(!0), (f = k.caret !== i ? k.caret : q(k.pos.begin ? k.pos.begin : k.pos)), (M().p = f)),
              ...
              if (I().join('') !== r) {
                ...
                if (
                  ...
                  if (
                    ...
                    g.begin === g.end - 1 &&
                      ((g.begin = Q(g.begin + 1)), g.begin === g.end - 1 ? ne(a, g.begin) : ne(a, g.begin, g.end));
            ...
            focusEvent: function(e) {
              ...
              p.showMaskOnFocus &&
                ...
                (t.inputmask._valueGet() !== I().join('') ? W(t, I(), q(O())) : !1 === A && ne(t, q(O()))),
                  ...
                  if (
                    ...
                    -1 ===
                      ...
                      (T(g).match.nativeDef !== v.charAt(0) &&
                        (' ' !== T(g).match.nativeDef || T(g + 1).match.nativeDef !== v.charAt(0))) ||
                      a ||
                      p.autoUnmask)
                  ) {
          ...
          if (r === i)
            return (
              a.setSelectionRange
                ...
                : t.getSelection
                ? ((u = t.getSelection().getRangeAt(0)).commonAncestorContainer.parentNode !== a &&
                  ...
                  (o =
                    (r =
                      ...
                      (u = n.selection.createRange())
                        .duplicate()
                        .moveStart('character', -a.inputmask._valueGet().length)) + u.text.length),
        ...
        function oe(e, t, n, a, r) {
          if (
            (p.numericInput || b) &&
            (t === u.keyCode.BACKSPACE ? (t = u.keyCode.DELETE) : t === u.keyCode.DELETE && (t = u.keyCode.BACKSPACE),
            b)
          ) {
            var o = n.end;
          ...
          if (
            (t === u.keyCode.BACKSPACE && (n.end - n.begin < 1 || !1 === p.insertMode)
              ...
              : t === u.keyCode.DELETE &&
                n.begin === n.end &&
                ((n.end =
                  z(n.end, !0) && M().validPositions[n.end] && M().validPositions[n.end].input !== p.radixPoint
                    ? n.end + 1
                    : q(n.end) + 1),
                M().validPositions[n.begin] !== i && M().validPositions[n.begin].input === p.groupSeparator && n.end++),
            U(n),
            (!0 !== a && !1 !== p.keepStatic) || null !== p.regex)
          ) {
            var s = H(!0);
            if (s) {
              var l = s.caret !== i ? s.caret : s.pos ? q(s.pos.begin ? s.pos.begin : s.pos) : O(-1, !0);
        ...
        if (
          ...
          switch (a.action) {
            ...
            case 'mask':
              !(function(t) {
                                    ...
                                    e.valHooks[t] = {
                                      get: function(e) {
                                        if (e.inputmask) {
                                          ...
                                          var t = n(e);
                                          return -1 !== O(i, i, e.inputmask.maskset.validPositions) || !0 !== a.nullable
                                            ? t
                                            : '';
                                        }
                                        return n(e);
                ...
                if (
                  ...
                  !0 === p.colorMask && se(y),
                  r &&
                    ('inputmode' in y && ((y.inputmode = p.inputmode), y.setAttribute('inputmode', p.inputmode)),
                  ...
                  (d = G().join('')),
                  '' !== y.inputmask._valueGet(!0) || !1 === p.clearMaskOnLostFocus || n.activeElement === y)
                ) {
                  var o =
                    (e.isFunction(p.onBeforeMask) && p.onBeforeMask.call(k, y.inputmask._valueGet(!0), p)) ||
                    y.inputmask._valueGet(!0);
                  '' !== o && X(y, !0, !1, b ? o.split('').reverse() : o.split(''));
                  var l = I().slice();
                  (d = l.join('')),
                    !1 === re(l) && p.clearIncomplete && w(),
                    p.clearMaskOnLostFocus && n.activeElement !== y && (-1 === O() ? (l = []) : ae(l)),
            ...
            case 'format':
              return (
                (Z = ((e.isFunction(p.onBeforeMask) && p.onBeforeMask.call(k, a.value, p)) || a.value).split('')),
      ...
      return (
        (u.prototype = {
          ...
          getemptymask: function() {
            return (
              (this.maskset = this.maskset || p(this.opts, this.noMasksCache)), m.call(this, { action: 'getemptymask' })
            );
          },
          ...
          isComplete: function() {
            return (
              (this.maskset = this.maskset || p(this.opts, this.noMasksCache)), m.call(this, { action: 'isComplete' })
            );
          },
          getmetadata: function() {
            return (
              (this.maskset = this.maskset || p(this.opts, this.noMasksCache)), m.call(this, { action: 'getmetadata' })
            );
          },
          isValid: function(e) {
            return (
                ...
                switch (o.charAt(0)) {
                  ...
                  case a.alternatormarker:
                    ...
                    if (g.length > 0) {
                      ...
                      p =
                        l.openGroup && (j.matches === i || (!1 === j.isGroup && !1 === j.isAlternator))
                          ? g.pop()
                          : _(l.matches);
                    } else p = _(h.matches);
                    if (p.isAlternator) g.push(p);
                    else if (
                      (p.alternatorGroup ? ((c = g.pop()), (p.alternatorGroup = !1)) : (c = new k(!1, !1, !1, !0)),
                      c.matches.push(p),
                      g.push(c),
                      p.openGroup)
                    ) {
                  ...
                  ? ((o = o.replace(/[^0-9]/g, '')),
                    (o +=
                      i.min.year == i.max.year
                        ...
                        : ('' !== o && 0 == i.max.year.indexOf(o) ? parseInt(i.max.year) - 1 : parseInt(i.min.year) + 1)
                            .toString()
                            .substr(o.length)))
                  : (o = o.replace(/[^0-9]/g, '0')),
                o)),
          ...
          numeric: {
              ...
              if (
                ...
                isFinite(s[0]) && s[1] && isFinite(s[1])
                  ...
                  : (isNaN(e.digits) || parseInt(e.digits) > 0) &&
                    (e.digitsOptional ? (r += '[' + o + ';{1,' + e.digits + '}]') : (r += o + ';{' + e.digits + '}'));
              }
            ...
            preValidation: function(t, i, a, r, o, s) {
              if ('-' === a || a === o.negationSymbol.front)
                return (
                  !0 === o.allowMinus &&
                  ((o.isNegative = o.isNegative === n || !o.isNegative), '' === t.join('') || { caret: i, dopost: !0 })
                );
            ...
            postValidation: function(i, a, r) {
              ...
              if (
                ((p = (p = (p = (p = p.replace(o, '')).replace(
                  ...
                  ''
                )).replace(new RegExp('[-' + t.escapeRegex(r.negationSymbol.front) + ']', 'g'), '')).replace(
                  ...
                  case 'checkval':
                    ...
                    if (
                      ((l = o).parseMinMaxOptions === n &&
                        (null !== l.min &&
                          ((l.min = l.min.toString().replace(new RegExp(t.escapeRegex(l.groupSeparator), 'g'), '')),
                          ',' === l.radixPoint && (l.min = l.min.replace(l.radixPoint, '.')),
                          (l.min = isFinite(l.min) ? parseFloat(l.min) : NaN),
                          isNaN(l.min) && (l.min = Number.MIN_VALUE)),
                        null !== l.max &&
                          ((l.max = l.max.toString().replace(new RegExp(t.escapeRegex(l.groupSeparator), 'g'), '')),
              ...
              return (
                ...
                i.unmaskAsNumber
                  ? ('' !== i.radixPoint &&
                    ...
                    (a = (a = a.replace(new RegExp('^' + t.escapeRegex(i.negationSymbol.front)), '-')).replace(
            ...
            isComplete: function(e, n) {
              ...
              return (
                (a = (a = (a = (a = a.replace(new RegExp(t.escapeRegex(n.negationSymbol.back) + '$'), '')).replace(
                  n.prefix,
                  ''
            ...
            onBeforeMask: function(e, i) {
              if (
                ((i.isNegative = n),
                'number' == typeof e && '' !== i.radixPoint && (e = e.toString().replace('.', i.radixPoint)),
                (e =
