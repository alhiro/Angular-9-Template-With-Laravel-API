      ...
      if (
        ...
        return (
          ...
          (!lowestDelta || lowestDelta > absDelta) &&
            ((lowestDelta = absDelta), shouldAdjustOldDeltas(orgEvent, absDelta) && (lowestDelta /= 40)),
...
(jvm.$ = jQuery),
  ...
  (jvm.DataSeries = function(params, elements, map) {
    ...
    (params = params || {}),
      ...
      jvm.$.isArray(params.scale)
        ? ((scaleConstructor =
            'fill' === params.attribute || 'stroke' === params.attribute ? jvm.ColorScale : jvm.NumericScale),
          (this.scale = new scaleConstructor(params.scale, params.normalizeFunction, params.min, params.max)))
        : (this.scale = params.scale ? new jvm.OrdinalScale(params.scale) : new jvm.SimpleScale(params.scale)),
      (this.values = params.values || {}),
      this.setValues(this.values),
      this.params.legend &&
        (this.legend = new jvm.Legend($.extend({ map: this.map, series: this }, this.params.legend)));
  }),
    ...
    return (
      this.config.label &&
        ('function' == typeof this.config.label.offsets
          ...
          : 'object' == typeof this.config.label.offsets && (offsets = this.config.label.offsets[key])),
      offsets || [0, 0]
    );
  }),
  ...
  (jvm.Marker.prototype.setStyle = function(property) {
    ...
    jvm.Marker.parentClass.prototype.setStyle.apply(this, arguments),
      ...
      isImage != this.isImage &&
        ((this.isImage = isImage), (this.config.style = jvm.$.extend(!0, {}, this.shape.style)), this.createShape());
  }),
    ...
    (this.canvas = new jvm.VectorCanvas(this.container[0], this.width, this.height)),
      ...
      this.params.focusOn &&
        ('string' == typeof this.params.focusOn
          ...
          : jvm.$.isArray(this.params.focusOn) && (this.params.focusOn = { regions: this.params.focusOn }),
  ...
  (jvm.Map.prototype = {
      ...
      var map = this,
        ...
        handleGestureEvent = function(e) {
          ...
          (0 != e.translationX || 0 != e.translationY) &&
            ...
            (transXOld != map.transX || transYOld != map.transY) && e.preventDefault()),
            1 != e.scale &&
              (map.setScale(map.scale * e.scale, e.offsetX, e.offsetY), map.tip.hide(), e.preventDefault());
        };
          ...
          'mouseover' == e.type
            ? (map.container.trigger(overEvent, [code]),
              ...
              tipShowEvent.isDefaultPrevented() ||
                (map.tip.show(), (map.tipWidth = map.tip.width()), (map.tipHeight = map.tip.height())))
    ...
    setScale: function(scale, anchorX, anchorY, isCentered, animate) {
      ...
      return (
        scale > this.params.zoomMax * this.baseScale
          ? (scale = this.params.zoomMax * this.baseScale)
          : scale < this.params.zoomMin * this.baseScale && (scale = this.params.zoomMin * this.baseScale),
    ...
    getInsetForPoint: function(x, y) {
      var i,
        ...
        insets = jvm.Map.maps[this.params.map].insets;
      for (i = 0; i < insets.length; i++)
        if (((bbox = insets[i].bbox), x > bbox[0].x && x < bbox[1].x && y > bbox[0].y && y < bbox[1].y))
          return insets[i];
    },
  ...
  (jvm.Map.defaultParams = {
    ...
    regionLabelStyle: {
      initial: { 'font-family': 'Verdana', 'font-size': '12', 'font-weight': 'bold', cursor: 'default', fill: 'black' },
