...
$('.user-list-box .person').on('click', function(event) {
  ...
  if (
    $(this)
      .parents('.user-list-box')
      .hasClass('user-list-box-show')
  ) {
    $(this)
      .parents('.user-list-box')
      .removeClass('user-list-box-show');
  }
...
$('.cancel-call').on('click', function(event) {
  if (
    ...
    var setCallStatusText = $(this)
      ...
      .find('.call-status')
      .text('Calling...');
    var removeVideoConnectClass = $(this)
      .parents('.overlay-video-call')
      .removeClass('onConnect');
