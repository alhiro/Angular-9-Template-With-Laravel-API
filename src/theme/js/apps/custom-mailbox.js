$(document).ready(function() {
  ...
  $('.mail-menu').on('click', function(e) {
    $(this)
      .parents('.mail-box-container')
      .children('.tab-title')
      .addClass('mail-menu-show');
    $(this)
      .parents('.mail-box-container')
      .children('.mail-overlay')
      .addClass('mail-overlay-show');
  });
  ...
  function contentBoxPosition() {
    $('.content-box .collapse').on('show.bs.collapse', function(event) {
      ...
      var getSelectedMailContentTitle = $(this)
        .find('.mail-content')
        .attr('data-mailTitle');
      $(this)
        .parent('.content-box')
  ...
  var $listbtns = $('.list-actions').click(function() {
    $(this)
      .parents('.mail-box-container')
      .find('.mailbox-inbox > .content-box')
      .css({
        width: '0',
        left: 'auto',
        right: '-46px'
    ...
    $('.content-box .collapse').collapse('hide');
    var getActionCenterDivElement = $(this)
      .parents('.mail-box-container')
      .find('.action-center');
  ...
  $('.action-delete').on('click', function() {
    ...
    var notificationText =
      getCheckedItemlength < 2 ? getCheckedItemlength + ' Mail Deleted' : getCheckedItemlength + ' Mails Deleted';
  ...
  $('.revive-mail').on('click', function() {
    ...
    var getCheckedItemlength = $('.inbox-chkbox:checked').length;
    var notificationText =
      getCheckedItemlength < 2 ? getCheckedItemlength + ' Mail restored' : getCheckedItemlength + ' Mails restored';
  ...
  $('.label-group-item').on('click', function() {
    ...
    if (
      $('.inbox-chkbox:checked')
        .parents('.mail-item-heading')
        .hasClass(splitLabelColor)
    ) {
      var notificationText =
        getCheckedItemlength < 2
    ...
    $('#btn-send')
      ...
      .on('click', function(event) {
        ...
        var outerConditionHTML =
          $_mailAttachment.files.length >= 1 ? '<div class="attachments">' + $outerAttachmentHTML + '</div>' : '';

        var innerConditionHTML =
          $_mailAttachment.files.length >= 1 ? '<div class="attachments">' + $innerAttachmentHTML + '</div>' : '';
    ...
    $('.mail-item.draft')
      ...
      .on('click', function(event) {
        ...
        var $_mailSubject = $(this)
          .find('.mail-title')
          .attr('data-mailtitle');
        var $_mailDataTarget = $(this)
          .find('.mail-item-heading')
          .attr('data-target');
        $_sendMail($_mailDataTarget);
        var $_mailDescription = JSON.parse(
          $(this)
            .find('.mail-content-excerpt')
